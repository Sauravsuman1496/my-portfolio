...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "34ebe1e6-50d7-4e30-86e3-010a955f24e3");
    ...
    dark:bg-none'>
      ...
      onSubmit={onSubmit}     className='max-w-2xl mx-auto'>
        <div className='grid grid-cols-auto gap-6 mt-10 mb-8' >
            ...
            rounded-md bg-white dark:bg-darkHover/30 dark:border-white/90' name='name'></motion.input>
            ...
            type='email' placeholder='Enter your email' required
             className='flex-1 p-3 outline-none border-[0.5px] border-gray-400
             rounded-md bg-white  dark:bg-darkHover/30 dark:border-white/90' name='email'></motion.input>
        ...
        dark:border-[0.5px] dar:hover:bg-darkHover'>Submit now 
