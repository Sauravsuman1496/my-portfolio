...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='grid grid-cols-auto my-10 gap-5 dark:text-black'>
        {workData.map((project,index)=> (
            ...
            py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7'>
                ...
                aspect-square flex items-center justify-center shadow-[2px_2px_0#000] group-hover:bg-lime-300 transition'>
      ...
      Show more <Image src={ isDarkMode ? assets.right_arrow_bold_dark  : assets.right_arrow_bold} alt='Right arroe' className='w-4'/>
      </motion.a>
    </motion.div>
  )
}
